...
<body>
  ...
  <main>
    ...
    <div class="view" id="view-about"><section class="panel panel-pad"><h2>About This Snapshot</h2><p>Generated from canonical DuckDB data at {generated}. The app embeds dashboard summaries plus Parquet route/game data and queries it locally with DuckDB-WASM.</p><p id="about-counts" class="note"></p><p class="note">Network is still used for map tiles, typed geocoding, OSRM route geometry, and the DuckDB-WASM library CDN. The arcade dataset itself is inside this HTML file.</p></section></div>
  </main>
